...
-(UIImage *)imageByScalingToSize:(CGSize)size andCroppingWithRect:(CGRect)rect {
    ...
    UIImage *scaledImage = [UIImage imageWithCGImage:scaledImageRef scale:self.scale orientation:UIImageOrientationUp];
    ...
    CGImageRef preCroppedImageRef = CGImageCreateWithImageInRect(scaledImage.CGImage, rect);
    UIImage *image = [UIImage imageWithCGImage:preCroppedImageRef scale:self.scale orientation:UIImageOrientationUp];
    CGImageRelease(preCroppedImageRef);
