...
// IF use hasn't started writing bring up keyboard; if user is done writing send comment to API
...
//implement text view delegate methods
//update state, communicate user intent and return yes to let user do what she wants
